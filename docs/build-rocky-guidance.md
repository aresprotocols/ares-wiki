...
打开 https://my.vultr.com/deploy/ ，注册进入首页。左侧点击“Products”栏目，选择“Cloud Computer”服务。
...
下载程序 http://www.hostbuf.com/downloads/finalshell_install.pkg，右击“打开”进行程序安装。选择安装位置，点击“安装”即可完成。
...
1、 下载节点的二进制执行程序：
下载地址：https://github.com/aresprotocols/ares/releases/tag/v1.0.5 
尽量选择最新的版本下载，如下例子是 v211028 版本


可执行的 gladios-node 二进制文件：
wget -c https://github.com/aresprotocols/ares/releases/download/v1.0.5/gladios-node
...
如何打开如下的界面，访问 https://js.aresprotocol.io/?rpc=wss%3A%2F%2Fgladios.aresprotocol.io#/explorer/
...
注意⚠️：以上的操作(第一步)请在自己部署的节点或者信任的节点进行。因为生成的公钥所对应的私钥(privateKey)会存储到该节点keystore下。
CLI​
